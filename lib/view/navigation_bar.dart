...
class _BottomNavigationDotBarState extends State<BottomNavigationDotBar> {
  ...
  void initState() {
    ...
    _padding = widget.padding ?? const EdgeInsets.fromLTRB(10, 0, 10, 5);
    _animationSpeed = widget.animationSpeed ?? 400;
    _indicator = widget.indicator ??
        CircleAvatar(
            radius: 2.5,
            backgroundColor:
                widget.useThemeColors ? widget.activeColor : Colors.black);
...
class _NavigationIconButtonState extends State<_NavigationIconButton>
  ...
  void initState() {
    ...
    _scaleAnimation =
        Tween<double>(begin: 1, end: 0.93).animate(_controller!.view);
  }
